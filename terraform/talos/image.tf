# Image Factory Integration for custom Talos images
locals {
...
# Post updated schematic to get ID (for upgrades)
...
# Download Talos images to Proxmox nodes
